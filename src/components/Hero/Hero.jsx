	...
	return (
		<aside>
			<motion.div
				...
				/>
				<motion.p variants={titleChildAnimate}>Ponte en forma</motion.p>
				<motion.p variants={titleChildAnimate} className={heroclasses['title-italic']}>
				y mantente 
				</motion.p>
				<motion.p variants={titleChildAnimate}>Saludable</motion.p>
			</motion.div>
			<div>
				<IconContext.Provider value={{size: '4em', color: 'white'}}>
					<motion.div
						...
						<div className={heroclasses['fitness-text__wrapper']}>
							<p>
								Ponerse en forma y mantenerse saludable implica una combinación de factores, entre ellos una dieta equilibrada.
							</p>
						</div>
